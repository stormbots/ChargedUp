...
public enum BlinkenPattern {	
	...
	SOLID_ORANGE                       (1795,0.59),   //  PATTERN  80
	// LIME_GREEN                         (1805,0.61),   //  PATTERN  81
	SOLID_RED_ORANGE                   (1815,0.63),   //  PATTERN  82
	// LIGHT_GREEN                        (1825,0.65),   //  PATTERN  83
	SOLID_GOLD                         (1835,0.67),   //  PATTERN  84
	SOLID_GREEN_DARK                   (1845,0.69),   //  PATTERN  85 
	SOLID_GREEN                        (1855,0.71),   //  PATTERN  86
	SOLID_LIGHT_BLUE                   (1865,0.73),   //  PATTERN  87  
	// LIGHT_BLUE                         (1875,0.75),   //  PATTERN  88
	// BRIGHT_BLUE                        (1875,0.75),   //  PATTERN  89
	// DEFUALT_BLUE                       (1895,0.79),   //  PATTERN  90
	// BRIGHT_DEFAULT_BLUE                (1905,0.81),   //  PATTERN  91 
	SOLID_LAVENDER                     (1915,0.83),   //  PATTERN  92 
	SOLID_MAGENTA                      (1925,0.85),   //  PATTERN  93
